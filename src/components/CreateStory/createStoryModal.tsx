...
const CreateStoryModal: NextPage = () => {
  return (
    <>
      <div className="bg-yellow-100 w-[295px] h-[288px] rounded-2xl mt-[-500px] ml-[-3px] fixed">
        <div>
          <Image
            className="mt-[14.95px] ml-[223px]"
          ...
          <div className="w-[210px] h-[57px] mt-[19px] ml-[17%]">
            <div>사연 등록이 완료되었습니다.</div>
            <div>이제 지도에서</div>
            <div>나의 사연을 확인하실 수 있어요:)</div>
          </div>
          <Image
            className="w-[108px] h-[108px] ml-[28%] mt-[19px]"
