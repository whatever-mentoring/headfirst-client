    ...
    <>
      <div className="">
        <div className="w-[303px] h-[481px] shadow-2xl mt-[12px] ml-[30px] rounded-[18.18px]">
          <div className="w-[212px] h-[21px] pt-[41px] font-[StoryFont] text-[#242424] ml-[29px] cursor-text	">
            <input
          ...
          <div className="bg-createStoryContentBg w-[254px] h-[359px] mt-[48px] ml-[24px] text-createStoryContentColor pl-[20px] pt-[24px] rounded-[8px]">
            <textarea
              className="focus:outline-none focus:shadow-none bg-createStoryContentBg w-[212px] h-[312px] cursor-text	"
